  ...
  return (
    <div className="min-h-screen bg-background pb-24 max-w-md mx-auto">
      ...
      <div className="relative">
        ...
        />
        <span className="bg-[#EFF6FF] dark:bg-[#1E293B] text-[#2563EB] dark:text-primary text-sm px-3 py-1.5 rounded-2xl font-bold shadow-lg absolute top-4 left-4">
          D-3
        </span>
      </div>
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        {activeTab === "overview" && (
          <div className="space-y-6">
            ...
            {/* Unit Types */}
            <div>
              <h3 className="font-semibold mb-4">타입별 정보</h3>
          ...
          <div className="space-y-4">
            <div className="bg-primary/10 border border-primary/30 rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-semibold">청약 일정</h3>
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">청약 접수</span>
                  <span className="text-sm font-semibold">2025.11.20 (목) ~ 11.21 (금)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">당첨자 발표</span>
                  <span className="text-sm font-semibold">2025.11.28 (목)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">계약 체결</span>
                  <span className="text-sm font-semibold">2025.12.05 (목) ~ 12.10 (화)</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">입주 예정</span>
                  <span className="text-sm font-semibold">2027.03</span>
                </div>
              </div>
            </div>

            <div className="bg-card border border-border rounded-2xl p-5">
              <h3 className="font-semibold mb-4">공급 일정</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2"></div>
                  <div className="flex-1">
                    <p className="font-medium mb-1">1순위 청약 (��주택자)</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium mb-1">2순위 청약</p>
        ...
        {activeTab === "location" && (
          <div className="space-y-4">
            ...
            <div className="bg-card border border-border rounded-2xl p-5">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">지하철 8호선 문정역</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">버스 정류장 5개소</p>
            ...
            {/* Nearby Facilities */}
            <div className="bg-card border border-border rounded-2xl p-5">
              <h3 className="font-semibold mb-4">주변 시설</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-primary/10 to-blue-50 dark:from-primary/10 dark:to-blue-900/30 border border-primary/30 rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-bold">AI 종합 분석</h3>
              </div>
              ...
              <div className="flex items-center gap-2 p-3 bg-card rounded-xl border border-border">
                ...
                <p className="text-sm font-semibold">종합 평가: 매우 우수</p>
              </div>
            </div>

            {/* Price Comparison */}
            <div className="bg-card border border-border rounded-2xl p-5">
              <h3 className="font-semibold mb-4">타입별 분양가 비교</h3>
              <ResponsiveContainer width="100%" height={200}>
            ...
            {/* Area Score Radar */}
            <div className="bg-card border border-border rounded-2xl p-5">
              <h3 className="font-semibold mb-4">지역 종합 점수</h3>
